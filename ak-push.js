...
(function(window) {
    ...
    var injectedConfig = {
        ...
        firebase: {
            ...
            messagingSenderId: "867245989769",
        },
        browsers: {
            "Chrome": {
            ...
            "Safari": {
                websitePushID: "",
                websitePushAPI: "https://pxl.ru.altkraft.com/ap",
            },
        },
                ...
                .then(
                    function(token) {
                        ...
                        if (that.localToken() != token) {
                            ...
                            that.sendSubscription("save", that.config.browser + "Firebase", subscription, match, update, customData);
                        }
